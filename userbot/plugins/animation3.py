...
@lionx.lion_cmd(
    pattern="solarsystem$",
    command=("solarsystem", plugin_type),
    info={
        "header": "Fun animation try yourself to know more",
