...
@lionx.lion_cmd(
    ...
    command=("prankpromote", plugin_type),
    info={
...
async def _(event):
    ...
    try:
        ...
        return await eod(lionxevent, f"__{e}__", time=10)
    await lionxevent.edit("`Promoted Successfully! Now gib Party`")


@lionx.lion_cmd(
    pattern="padmin$",
    command=("padmin", plugin_type),
    info={
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1902787452:
            await reply_message.reply(
                "`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 99$ to my master__ [SimpleBoy](https://t.me/Simpleboy786) __to release your account__😏"
            )
        else:
            jnl = (
                "`Warning!! `"
