...
@lionx.lion_cmd(
    ...
    command=("penis|dick", plugin_type),
    info={
        "header": "bad art, try yourself ",
        "usage": "{tr}penis",
    },
