...
async def get_users(show):
    ...
    lionxevent = await eor(show, "`getting users list wait...`  ")
    try:
...
@lionx.lion_cmd(
    ...
    info={
        ...
        "examples": "{tr}chatinfo @TeamLionX",
    },
)
async def info(event):
    "To get group information"
    lionxevent = await eor(event, "`Analysing the chat...`")
