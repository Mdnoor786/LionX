...
async def some(event):
    ...
    lionxevent = await eor(event, "`Sending gif....`")
...
async def some(event):
    ...
    lionxevent = await eor(event, "`Wait babe...`😘")
