...
@lionx.lion_cmd(
    pattern="porn(?:\s|$)([\s\S]*)",
    command=("porn", plugin_type),
    info={
        "header": "Get a porn video or gif or pic. Check [Nekos Queries](https://telegra.ph/ᶦᶰᵈᴍᵒʰᵈ-ɴᵒᵒʳツ-03-18-4) ",
        "usage": [
            "{tr}porn",
            "{tr}porn <options>",
        ],
...
async def _(event):
    ...
    if owo in neko_category:
        ...
        await eor(
            event,
            f"**Unmatched argument.** \n\n__Get all the required queries for nekos here__ -> **[Nekos Queries](https://telegra.ph/ᶦᶰᵈᴍᵒʰᵈ-ɴᵒᵒʳツ-03-18-4)**",
        )
