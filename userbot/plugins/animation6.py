...
@lionx.lion_cmd(
    pattern="vquickheal$",
    command=("vquickheal", plugin_type),
    info={
        "header": "Fun animation try yourself to know more",
        "usage": "{tr}vquickheal",
    },
